...
The use report `URs()` function calculates the use report (UR) for each species in the data set (see Prance et al. 1987). 
...
The `UVs()` function calculates the use value (UV) index for each species in the data set (see Tardio and Pardo-de-Santayana 2008).
\begin{equation}
UV_{s} = \sum U_i/N
\end{equation}
...
Gaoue, Orou G., Michael A. Coe, Matthew Bond, Georgia Hart, Barnabas C. Seyler, and Heather McMillen. 2017. Theories and Major Hypotheses in Ethnobotany. Economic Botany 71: 269–287. <https://doi.org/10.1007/s12231-017-9389-8>.
