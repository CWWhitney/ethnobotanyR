...
Install the released version of ethnobotanyR from [CRAN](https://CRAN.R-project.org) with:

``` r
install.packages("ethnobotanyR")
```

Install the working version of ethnobotanyR from [GitHub](https://github.com) with:
