...
#' @section Application:
#' 
#'  This function was inspired by Rasmus Bååth's “The Non-Parametric Bootstrap as a Bayesian Model” Publishable Stuff, 2015. \url{https://sumsar.net/blog/2015/04/the-non-parametric-bootstrap-as-a-bayesian-model/}.
